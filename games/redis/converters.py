...
class PlayerConverter(BaseRedisConverter):
    ...
    def dc_model_to_dict_model(dc_model: PlayerDC,
        ...
        player_dict = PlayerDict(
            ...
            clockwise_player_id=dc_model.clockwise_player_id,
            counterclockwise_player_id=dc_model.counterclockwise_player_id,
    ...
    def hash_model_to_dc_model(hash_model: PlayerHash,
        ...
        player_dc = PlayerDC(
            ...
            clockwise_player_id=int(hash_model[b'clockwise_player_id']),
            counterclockwise_player_id=int(hash_model[b'counterclockwise_player_id']),
